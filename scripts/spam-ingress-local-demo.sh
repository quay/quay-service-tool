...
PLAYWRIGHT_SLOW_MO="${PLAYWRIGHT_SLOW_MO:-800}"
DEMO_STEP_DELAY="${DEMO_STEP_DELAY:-5300}"
DEMO_CLICK_DELAY="${DEMO_CLICK_DELAY:-1000}"
...
Environment overrides:
  ...
  DEMO_STEP_DELAY=5300
  DEMO_CLICK_DELAY=1000
  HOLD_SECONDS=600
USAGE
}
...
browse_service_tool() {
  ...
  (
    ...
    SERVICE_TOOL_URL="$SERVICE_TOOL_URL" \
      ...
      DEMO_CLICK_DELAY="$DEMO_CLICK_DELAY" \
