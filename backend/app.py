...
if spam_detection_data_dir and not os.environ.get("SPAM_DETECTION_STATE_DB_URI"):
    app.config["SPAM_DETECTION_STATE_DB_URI"] = default_state_db_uri
if spam_detection_data_dir and not os.environ.get("SPAM_DETECTION_ARTIFACT_STORAGE"):
...
if not spam_detection_data_dir:
